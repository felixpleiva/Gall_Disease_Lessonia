...
png("1.2. Gall prevalence per maturity.png", height=7, width=9, units="in", res=200)
library(gridExtra)
...
png("1.3. Gall prevalence per stage.png", height=7, width=9, units="in", res=200)
library(gridExtra)
...
model.sel#el mas informativo es el que considera el mes como variable explicativa
#########################################################################################
